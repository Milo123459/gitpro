    ...
    rsx! {
        ...
        div { id: "container",
            ...
            div { class: "home_buttons",
                a { href: "https://github.com/login/oauth/authorize?client_id=Ov23liICKYW0zOWqK6xS&redirect_uri=https://romantic-energy-production-e83d.up.railway.app/auth/github&scope=repo", target: "_blank", button { "Link Github" } }
            }
